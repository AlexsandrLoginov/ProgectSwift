//Оператор присваения
var a = 1
// К "а" присврили значение "1" при помощи оператора присвоения "="

//Орефметические операторы
//Оператор сложения
var plus = 1 + 2
//Оператор вычитания
var minus = 4 - 1
...
//Оператор целочисленного диления, возврощает остаток от диления
...
// Это сокраченая форма записи if
var pey2 = salary
if plan {
    pey2 = salary + 10000
}else{
...
//Оператор объединуния по nil (есть вопросы)
let weather = "Пасмурно"
var weather2: String?
var umbrella = weather2 ?? weather

//Операторы диапазона
//Оператор зазамкнутого диапазона
